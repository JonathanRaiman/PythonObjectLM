import numpy as np, threading, logging, time, sys, os, pickle, gzip, json
...
try:
    ...
    training_methods_imported = True
    err_msg = ""
except ImportError:
    err_msg = "Error: Scipy and Cython are required to train the model. To train a model install Scipy and Cython first."
    training_methods_imported = False
    print(err_msg)
    def train_sentence_concatenation(*args):
        raise NotImplementedError(err_msg)
    def predict_sentence_window(*args):
        raise NotImplementedError(err_msg)
...
try:
    ...
    print("WARNING: You do not have Theano installed, but this is a recommended dependency for ObjectlM")
...
class ObjectLM(object):
    ...
    def save_model_to_java(self, path):
        ...
        try:
            ...
            print("Error: you need Scipy to output Matlab matrices for Java exports.")
            raise
